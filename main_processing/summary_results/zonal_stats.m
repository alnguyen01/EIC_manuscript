...
labels = {'FWM: Carex Aquatillis', 'Wet Sedge', 'Tussock Tundra'}';
...
ax.FontSize = 15;
ylim([0, 25])
text(0.6, 23, 'A.)','FontSize',15,'FontWeight','bold')
...
ax.FontSize = 15;
ylim([0, 130])
text(0.6, 120, 'B.)','FontSize',15,'FontWeight','bold')
...
ax.FontSize = 15;
ylim([0, 15])
text(0.6, 14, 'C.)','FontSize',15,'FontWeight','bold')
...
ax = gca;
ax.FontSize = 15;
text(0.6, 6.5, 'D.)','FontSize',15,'FontWeight','bold')
...
ax = gca;
ax.FontSize = 15;
text(0.6, 7, 'A.)','FontSize',15,'FontWeight','bold')
...
ax = gca;
ax.FontSize = 15;
text(0.6, 20, 'B.)','FontSize',15,'FontWeight','bold')
...
ax = gca;
ax.FontSize = 15;
text(0.6, 4.7, 'C.)','FontSize',15,'FontWeight','bold')
...
ax = gca;
ax.FontSize = 15;
text(0.6, 0.45, 'D.)','FontSize',15,'FontWeight','bold')